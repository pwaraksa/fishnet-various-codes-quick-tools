...
index1 = len(filename)-4
index2 = len(filename)-5

print()
N = int(filename[index2]+filename[index1])-1
...
for i in rlist[N]:
    ...
    # per = round((683 - (rlist[N][683] - i)) * 100 / 683, 2)
    # #percent = round((i+1)*100/412,2)
    # print("polygon number: {} ({}/{}, {}%)".format(uniq_poly[i],i+1,rlist[N][683],per))
